...
export default function ISO24Page() {
    ...
    useEffect(() => {
        if (firebaseApp && isoQuery) {
            console.log('[DEBUG] projectId', firebaseApp.options.projectId);
            console.log('[DEBUG] ISO24 Query Path', (isoQuery as InternalQuery)._query.path.canonicalString());
        }
    }, [firebaseApp, isoQuery]);
